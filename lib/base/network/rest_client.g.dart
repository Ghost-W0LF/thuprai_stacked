...
class _RestClient implements RestClient {
  ...
  @override
  Future<SignupResponseModel> signup(SignupRequest signup) async {
  ...
  @override
  Future<AddCartRequest> addCart(AddCartRequest addToCart) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(addToCart.toJson());
    final _options = _setStreamType<AddCartRequest>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AddCartRequest _value;
    try {
      _value = AddCartRequest.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<CartPatchModel> updateCart(
    ...
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
    _data.addAll(patchModel.toJson());
    final _options = _setStreamType<CartPatchModel>(Options(
      method: 'PATCH',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CartPatchModel _value;
    try {
      _value = CartPatchModel.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
